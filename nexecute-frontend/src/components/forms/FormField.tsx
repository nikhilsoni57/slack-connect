  ...
  return (
    <div className={cn('space-y-2', className)}>
      ...
      <input
        ...
        disabled={disabled}
        className={cn(
          'block w-full px-3 py-2 border rounded-lg shadow-sm placeholder-secondary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm',
          error
